...
class TaskAddUpdateForm extends StatelessWidget {
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            CustomDropdownMenuWithModel<ReferenceDocumentModel>(
                              ...
                              items: refDocController.documents,
                              onChanged: onReferenceDocumentsChanged,
                              selectedItems: refDocController.documents
                                  .where((e) =>
                                      taskController.refDocIds.contains(e.id))
                                  .toList(),
                            ),
                            SizedBox(height: 10),
  ...
  void onReferenceDocumentsChanged(List<ReferenceDocumentModel?> refDocList) =>
      taskController.refDocIds = refDocList.map((e) => e?.id).toList();
